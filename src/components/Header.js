      ...
      <div className="header-content">
        <motion.div className="header-text" variants={itemVariants}>
          ...
          <motion.p className="description" variants={itemVariants}>
            Passionate about building intelligent applications with Python, AI, and Cloud technologies. I enjoy turning ideas into impactful solutions through innovation, continuous learning, and problem-solving.
          </motion.p>
        </motion.div>
